//g++ -o live_bg.opengl1 live_bg.opengl1.cpp `pkg-config.pkg-config --libs gl glew imlib2 x11` -lgif
...
//	glewExperimental=TRUE;
	...
	if( glewGetExtension( "GL_EXT_texture_compression_s3tc" ) )
	{
		...
		//gl_tex_format=GL_COMPRESSED_RGB_S3TC_DXT1_EXT;
		//gl_tex_format=GL_COMPRESSED_RGB;
